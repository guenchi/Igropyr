  ...
  (define (igropyr-styles . opts)
    ...
    `((:root (--bg "#ffffff") (--bg2 "#f6f8fa") (--panel "#f6f8fa")
      ...
      (pre (background (var bg2)) (border (px 1) solid (var line))
           ...
           (font-size (px 13 50)) (line-height (dec 1 60)))
      ...
      (.md-body (max-width (px 820)) (margin 0 auto) (padding (px 44) (px 24) (px 90))
                (color "#2b303a") (font-size (px 16)) (line-height (dec 1 70)))
      (".md-body > :first-child" (margin-top 0))
      (".md-body > h1:first-child" (letter-spacing "-.5px"))
      (".md-body h1, .md-body h2, .md-body h3, .md-body h4"
       (color (var fg)) (letter-spacing "-.3px") (line-height (dec 1 30))
      ...
      (".md-body code" (font-family ,mono) (font-size (em 0 90)) (background (var bg2))
      ...
      (".md-body table" (border-collapse collapse) (width (pct 100)) (margin "1.2em 0")
                        (font-size (em 0 95)) (display block) (overflow-x auto))
