...
(<span class=\"f\">rpc</span> <span class=\"s\">\"/rpc\"</span> '(add <span class=\"n\">1</span> <span class=\"n\">2</span> <span class=\"n\">1/2</span>))          <span class=\"c\">; =&gt; (ok 7/2) -- exact ratio intact</span>"))
