    ...
    (let ((b0 (base)) (no-row (count! 'proc-exit-cb-no-row)) (freed (count! 'proc-handle-freed))
      ...
      (let ((h0 (hits 'proc-exit-cb-no-row)))
        ...
        (let* ((r (spawn-sh "exec sleep 7118"))
          ...
          (check "P18: the OS child is gone and reaped within 2 s" (within? 2000 (lambda () (not (ps-has? "sleep 7118")))))
          ...
          (drain! 300)))
      (inject-disarm!)
      (let ((r (begin (inject-arm-fault! 'proc-publish-fail 1) (guard (e (#t (cons 'raised e))) (spawn-sh "exec sleep 7119")))))
        ...
        (check "P18 publish: the orphan row is present right after the call" (eqv? (proc-count) (+ (list-ref b0 3) 1)) (proc-count))
        (check "P18 publish: the child was killed and reaped" (within? 2000 (lambda () (not (ps-has? "sleep 7119")))))
      ...
      (let ((rl0 (hits 'proc-f13-relinked)))
        ...
        (check "P24b: the orphan was killed and reaped" (within? 2000 (lambda () (and (eqv? (proc-count) (list-ref b0 3)) (not (ps-has? "sleep 7124"))))) (proc-count))
        (drain! 300)
      ...
      (let ((r (spawn-sh "exec sleep 7127")))
        ...
        (check "P27 read-start: the orphan row is present right after the call" (eqv? (proc-count) (+ (list-ref b0 3) 1)) (proc-count))
        (check "P27 read-start: the child was killed and reaped" (within? 2000 (lambda () (not (ps-has? "sleep 7127")))))
        (back-to-base! "P27 read-start: active rollback, counts back" b0 3000)
        (drain! 300))
      (inject-disarm!)
      (inject-arm-fault! 'proc-publish-index-fail 1)
      (let ((r (guard (e (#t 'raised)) (spawn-sh "exec sleep 7128"))))
        ...
        (check "P27 index: the row was KEPT (orphan in proc-count right after the call)" (eqv? (proc-count) (+ (list-ref b0 3) 1)) (proc-count))
        (check "P27 index: reaped" (within? 2000 (lambda () (not (ps-has? "sleep 7128")))))
      ...
      (let ((u0 (hits 'proc-orphan-unindexed)) (r (guard (e (#t 'raised)) (spawn-sh "exec sleep 7129"))))
        ...
        (check "P27 recover: reaped" (within? 2000 (lambda () (not (ps-has? "sleep 7129")))))
      ...
      (let ((h0 (hits 'proc-exit-cb-no-row)))
        ...
        (let ((r (guard (e (#t 'raised)) (spawn-sh "exec sleep 7131"))))
          ...
          (check "P27 orphan-publish: the child is gone and not a zombie" (within? 3000 (lambda () (not (ps-has? "sleep 7131")))))
      ...
      (let ((p (spawn-sh "exec sleep 5")) (w0 (write-blocks-live-count)) (t0 (write-table-size))
        ...
        (let ((q0 (proc-queued p)) (w1 (write-blocks-live-count)))
          ...
          (let ((r (guard (e (#t 'raised)) (proc-write! p (make-bytevector 65536 9)))))
            ...
            (check "P30 pipe: the block was freed (live blocks back to the backlog's count)" (eqv? (write-blocks-live-count) w1) (list (write-blocks-live-count) w1))
