...
| json | string->json json->string json-object? json-array? json-null? json-ref/ref* json-set/set* json-drop/drop* json-push/push* json-insert/insert* json-update/update* (object = alist with string keys, array = vector, null = 'null; a list or a symbol in either place is refused, not converted) |
